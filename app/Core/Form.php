...
abstract class Form
{
	...
	/**
	 * Ajout un div avec un éditeur de texte
	 * Il faut que l'id de ma div soit égale à editor
	 * @param string $name = Nom de la div
	 * @param array $attributs
	 * @param string|null $value
	 * @return self
	 */
	public function addDivEditor(string $name, array $attributs = [], ?string $value = null): self
	{
		$this->formCode .= "<div name=\"$name\"";
		$this->formCode .= "id=\"editor\"";
		$this->formCode .= !empty($attributs) ? $this->addAttribute($attributs) . '>' : '>';
		$this->formCode .= $value . '</div>';
